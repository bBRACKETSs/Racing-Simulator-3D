...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class AICarAudio : MonoBehaviour
    {
        ...
        private AIController m_CarController; // Reference to car we are controlling
        ...
        private void Update()
        {
            ...
            float camDist = (Camera.allCameras[0].transform.position - transform.position).sqrMagnitude;
