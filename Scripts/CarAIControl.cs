...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        private AIController m_CarController;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            m_CarController = GetComponent<AIController>();
        ...
        IEnumerator BackManouver()
        {
            m_Driving = false;
            yield return new WaitForSeconds(0.3f);
            m_CarController.Move(0, -10f, -10f, 0f);
            yield return new WaitForSeconds(5f);
            m_Driving = true;
        }

        IEnumerator CarCorrection()
        {
            m_Driving = false;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                StartCoroutine(BackManouver());
            }

            if (other.CompareTag("Roads"))
            {
                StartCoroutine(CarCorrection());
            }
        }
